          ...
          {steps.map(({ num, icon: Icon }) => (
            <div key={num} className="relative flex flex-col items-center text-center">
              <div className="relative mb-6">
                <div className="w-24 h-24 rounded-2xl bg-card border border-border flex items-center justify-center shadow-xl">
                  <Icon className="w-10 h-10 text-emerald-500" />
                </div>
                <div className="absolute -top-3 -right-3 w-7 h-7 rounded-full bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-lg shadow-emerald-500/30">
                  {num}
                </div>
              </div>
