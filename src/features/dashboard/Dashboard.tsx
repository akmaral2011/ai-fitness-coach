  ...
  return (
    <div className="px-4 py-6 max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <StatCard label={t('dashboard.streak')} value={`${summary.currentStreak} 🔥`} />
        <StatCard label={t('dashboard.totalWorkouts')} value={summary.totalSessions} />
        <StatCard label={t('dashboard.avgScore')} value={`${summary.averageScore}%`} />
        <StatCard label={t('dashboard.totalReps')} value={summary.totalReps} />
      </div>
